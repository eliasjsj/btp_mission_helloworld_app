		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Olá Camarada App Title",
									"targetURL": "#sapbtpolacamaradaui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpolacamaradaui5-display": {
								"semanticObject": "sapbtpolacamaradaui5",
								"action": "display",
								"description": "Um app SAP Fiori Camarada.",
								"title": "Olá Camarada App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.olacamaradaui5",
									"url": sap.ui.require.toUrl("sap/btp/olacamaradaui5")
								}
							}
						}
					}
